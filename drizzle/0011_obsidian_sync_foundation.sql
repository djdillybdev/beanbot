...
CREATE INDEX `obsidian_task_status_updated_idx`
ON `obsidian_task` (`task_status`, `db_updated_at_utc`);
--> statement-breakpoint
CREATE INDEX `obsidian_task_sync_status_idx`
ON `obsidian_task` (`sync_status`);
--> statement-breakpoint
CREATE TABLE `obsidian_task_label` (
	`todoist_task_id` text NOT NULL,
	`label_name` text NOT NULL,
	`created_at_utc` text DEFAULT CURRENT_TIMESTAMP NOT NULL
);
--> statement-breakpoint
CREATE UNIQUE INDEX `obsidian_task_label_task_label_idx`
ON `obsidian_task_label` (`todoist_task_id`, `label_name`);
--> statement-breakpoint
CREATE INDEX `obsidian_task_label_name_idx`
ON `obsidian_task_label` (`label_name`);
--> statement-breakpoint
CREATE TABLE `obsidian_note_index` (
	`todoist_task_id` text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE `obsidian_sync_event` (
...
--> statement-breakpoint
CREATE INDEX `obsidian_sync_event_source_created_idx`
ON `obsidian_sync_event` (`source`, `created_at_utc`);
--> statement-breakpoint
CREATE INDEX `obsidian_sync_event_task_created_idx`
